        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="product-details-content">
                    <h4 class="fw-bold" style="font-size: 30px">{{$product->name}}</h4>
                    ...
                    <div class="pro-details-cart-wrap">
                        <div class="shop-list-cart-wishlist">
                            <a title="Add To Cart" class="add-to-cart-button" style="padding-bottom: 10px"
            ...
            @foreach($products as $product)
                <div class="product-wrapper">
                    ...
                    <div class="product-content text-center">
                        <h4>
                            <a class="fw-bold" href="/products/{{$product->id}}/details"
